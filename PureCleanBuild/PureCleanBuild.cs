...
namespace PureCleanBuild
{
  ...
  [ProvideUIContextRule(UIContextGuid,
    name: "Pure Clean Build Activation",
  ...
  public sealed class PureCleanBuild : AsyncPackage
  {
    /// <summary>
    /// VSPackage1 GUID string.
    /// </summary>
    public const string PackageGuidString = "a444cef9-42ff-4db4-a021-61029ca3adf2";

    public const string UIContextGuid = "5f8201b3-8963-49f1-94d4-cfd11266768d";

    /// <summary>
    /// Initializes a new instance of the <see cref="PureCleanBuild"/> class.
    /// </summary>
    public PureCleanBuild()
    {
    ...
    protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
    {
      ...
      await NukeBuild.InitializeAsync(this);
    }
